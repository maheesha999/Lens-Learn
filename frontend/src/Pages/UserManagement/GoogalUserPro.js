...
function GoogalUserPro() {
    ...
    return (
        <div className="add-post-container" style={{ 
            ...
            paddingBottom: '50px', // Increased padding for better spacing
            ...
            <div className="profile-layout" style={{ 
                position: 'relative', 
                zIndex: 2,
                maxWidth: '1200px',   // Added max width for better readability on large screens
                margin: '20px auto',  // Center the layout and add spacing
                padding: '0 15px',    // Add horizontal padding for mobile responsiveness
